...
func initTemplateData(n int) {
	...
	root := filepath.Join(gopath, "src/github.com/Sukhavati-Labs/go-miner")
	...
	for i := 0; scanner.Scan(); i++ {
		...
		if i < challengeInterval+1 {
			...
			newBlock := wire.NewEmptyMsgBlock()
			newBlock.Header = header
			basicBlocks = append(basicBlocks, newBlock)
		}
	}
...
func randomAddress() (chainutil.Address, *btcec.PrivateKey, error) {
...
func randomPoCAddress() (chainutil.Address, *pocec.PrivateKey, error) {
