...
func TestPlot(t *testing.T) {
	...
	mdb, err := sktdb_v1.NewSktDBV1("testdata", engine.UnknownOrdinal, pk, bl)
	if err != nil {
		t.Error(err)
		t.FailNow()
	}
...
func getProof(mdb *sktdb_v1.SktDBV1, challenge pocutil.Hash, pkHash pocutil.Hash) (proof *poc.Proof, err error) {
