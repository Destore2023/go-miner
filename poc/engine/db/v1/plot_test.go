...
func init() {
	...
	logging.Init("/tmp", "tmp-skt.log", logging.DebugLevel, 1, false)
}
...
func TestPlot(t *testing.T) {
	...
	mdb, err := pocdb_v1.NewPocDBV1("testdata", engine.UnknownOrdinal, pk, bl)
	if err != nil {
		t.Error(err)
		t.FailNow()
	}
...
func getProof(mdb *pocdb_v1.PocDBV1, challenge pocutil.Hash, pkHash pocutil.Hash) (proof *poc.Proof, err error) {
