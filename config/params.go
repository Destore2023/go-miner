...
// Register registers the network parameters for a Skt network.  This may
...
// Params defines a chain network by its parameters.  These parameters may be
// used by skt applications to differentiate networks as well as addresses
...
var ChainParams = Params{
	...
	// BIP 173.
	Bech32HRPSegwit: "sk", // always sk for main net
...
func UpdateGenesisBlock(block *wire.MsgBlock) {
	ChainParams.GenesisBlock = block
	// update ChainID
