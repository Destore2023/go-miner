...
// NewBlock returns a new instance of a skt block given an underlying
...
// NewBlockFromBytes returns a new instance of a skt block given the
...
// NewBlockFromReader returns a new instance of a skt block given a
...
// NewBlockFromBlockAndBytes returns a new instance of a skt block given
...
func NewBlockFromBlockAndBytes(msgBlock *wire.MsgBlock, serializedBlock []byte, mode wire.CodecMode) *Block {
	...
	switch mode {
	case wire.DB:
		block.serializedBlockDB = serializedBlock
	case wire.Packet:
		block.serializedBlockPacket = serializedBlock
	}
	return block
}
