...
// NewTx returns a new instance of a Skt transaction given an underlying
// wire.MsgTx.  See Tx.
...
// NewTxFromReader returns a new instance of a Skt transaction given a
