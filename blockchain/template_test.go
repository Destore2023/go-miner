...
func TestBlockchain_NewBlockTemplate(t *testing.T) {
	...
	_, address, _ := newWitnessScriptAddress([]*btcec.PublicKey{pk.PubKey()},
		1, chainutil.AddressClassWitnessV0, &config.ChainParams)
...
func TestSubsidy(t *testing.T) {
	amount102400000000, _ := chainutil.NewAmountFromInt(102400000000)
	amount51200000000, _ := chainutil.NewAmountFromInt(51200000000)
	amount25600000000, _ := chainutil.NewAmountFromInt(25600000000)
	amount12800000000, _ := chainutil.NewAmountFromInt(12800000000)
	amount6400000000, _ := chainutil.NewAmountFromInt(6400000000)
	amount3200000000, _ := chainutil.NewAmountFromInt(3200000000)
	amount1600000000, _ := chainutil.NewAmountFromInt(1600000000)
	amount800000000, _ := chainutil.NewAmountFromInt(800000000)
	amount400000000, _ := chainutil.NewAmountFromInt(400000000)
	amount200000000, _ := chainutil.NewAmountFromInt(200000000)
	amount100000000, _ := chainutil.NewAmountFromInt(100000000)
	amount50000000, _ := chainutil.NewAmountFromInt(50000000)
	amount25000000, _ := chainutil.NewAmountFromInt(25000000)
	amount12500000, _ := chainutil.NewAmountFromInt(12500000)
	amount6250000, _ := chainutil.NewAmountFromInt(6250000)
	amount0 := chainutil.ZeroAmount()
	testdata := []struct {
		height uint64
		result chainutil.Amount
	}{
		{
			height: 1,
	...
	for _, data := range testdata {
		...
		res, err := chainutil.NewAmount(subsidy)
		if err != nil {
