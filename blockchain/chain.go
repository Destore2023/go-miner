...
func (chain *Blockchain) calcSequenceLock(node *BlockNode, tx *chainutil.Tx, txStore TxStore) (*SequenceLock, error) {
...
func (chain *Blockchain) connectBlock(node *BlockNode, block *chainutil.Block) (err error) {
...
func (chain *Blockchain) attachBlock(block *chainutil.Block) {
...
// the main (best) chain.
func (chain *Blockchain) disconnectBlock(node *BlockNode, block *chainutil.Block) error {
...
func (chain *Blockchain) detachBlock(block *chainutil.Block) {
...
func (chain *Blockchain) connectBestChain(node *BlockNode, block *chainutil.Block, flags BehaviorFlags) error {
...
func (chain *Blockchain) RetrieveFaultPks() {
	...
	fpkList, heightList, err := chain.db.FetchAllFaultPubKeys()
	if err != nil {
