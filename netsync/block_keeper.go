...
func (bk *blockKeeper) locateBlocks(locator []*wire.Hash, stopHash *wire.Hash) ([]*chainutil.Block, error) {
...
func (bk *blockKeeper) processBlock(peerID string, block *chainutil.Block) {
	bk.blockProcessCh <- &blockMsg{block: block, peerID: peerID}
}

func (bk *blockKeeper) processBlocks(peerID string, blocks []*chainutil.Block) {
...
func (bk *blockKeeper) requireBlock(height uint64) (*chainutil.Block, error) {
...
func (bk *blockKeeper) requireBlocks(locator []*wire.Hash, stopHash *wire.Hash) ([]*chainutil.Block, error) {
